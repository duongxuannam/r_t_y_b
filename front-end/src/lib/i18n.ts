...
const translations = {
  en: {
    ...
    'todo.view.kanban': 'Kanban',
    'todo.view.list': 'List + detail',
    'todo.status': 'Status',
    'todo.selectTodoHint': 'Select a todo from the list to view details.',
  ...
  vi: {
    ...
    'todo.view.kanban': 'Kanban',
    'todo.view.list': 'Danh sách + chi tiết',
    'todo.status': 'Trạng thái',
    'todo.selectTodoHint': 'Chọn một todo ở danh sách bên trái để xem chi tiết.',
